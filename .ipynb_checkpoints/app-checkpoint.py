...
def cosine_similarity_model(artist, track_name, num_recommendations, spotify_data):
    ...
    if song_data is str:  # In case an error message is returned
        return song_data
...
def nn_recommendation(artist, track_name, num_recommendations, spotify_data):
    # 1. Preprocess the data for neural network input
    global audio_features 

    # Extract the relevant features for the input song
...
# ... [the rest of your import statements remain unchanged]
